...
const Guide: React.FC<propsType> = ({
  ...
  <>
    <Container className='pt-4 text-center guide pb-5 pb-sm-0'>
      <h1
        className='yellowText fs-2 mb-0'>{t('here comes the usage guide')}</h1>
      <p
        className='fs-6 mt-0'>{t('first of all, you can always return to this page')}</p>
      <p className='fs-5 mt-2 mb-3'>{t('the main parts of the app are')}</p>
      <p
        className='fs-6 my-2 yellowText'>{t('the balance page is used for')}</p>
      ...
      <p
        className='fs-5 mt-2 mb-3'>{t('after that let\'s create some categories')}</p>
      <p
        className='fs-6 my-2 yellowText'>{t('the categories page is used for')}</p>
      ...
      <p
        className='fs-6 my-2 yellowText'>{t('the profile page is used for')}</p>
      ...
      <p
        className='fs-6 my-2 yellowText'>{t('select dates range and balance')}</p>
